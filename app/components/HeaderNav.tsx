    ...
    <div>
        ...
        <header className='flex items-center justify-between bg-cyan-800 h-16'>
            <nav className=' flex items-center gap-8 text-white font-semibold'>
                ...
                <Link className="p-2 hover:bg-white hover:text-black rounded-full px-6" href={'/about'}>About</Link>
                <Link className="p-2 hover:bg-white hover:text-black rounded-full px-6" href="">Category</Link>
                <Link className="p-2 hover:bg-white hover:text-black rounded-full px-6" href={"/news"}>News</Link>
            </nav>
            <nav className='flex items-center gap-6 text-gray-500 font-semibold'>
                <Link className="text-white hover:text-red-500" href={'/'}>
                  <FaHeart/>  
                </Link>
